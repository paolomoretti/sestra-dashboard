<template>
  ...
  <div id="app" class="h-screen flex flex-col">
     <!-- Floating Controls --> <!-- Settings Button - Top Right -->
    <div class="absolute top-4 right-4 z-50"> <SettingsButton @open="openSettings" /> </div>
     <!-- Edit Mode Toggle - Top Left -->
    <div
      class="absolute top-4 left-4 z-50 flex items-center bg-black/50 backdrop-blur rounded-lg px-2 py-1"
    >
